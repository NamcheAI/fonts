...
def default_original_package() -> Path:
    ...
    # Entwurf/geist-font-original/sources/Geist.glyphspackage
    return here.parent.parent / "geist-font-original" / "sources" / "Geist.glyphspackage"


def default_package() -> Path:
    here = Path(__file__).resolve().parent
    return here.parent / "sources" / "Geist.glyphspackage"
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    ap.add_argument(
        ...
        help="Path to Geist.glyphspackage",
    )
    ap.add_argument(
        "--radius",
        type=float,
    ...
    ap.add_argument(
        "--reset-sources",
        action="store_true",
        help="Replace working Geist.glyphspackage with immutable geist-font-original copy and exit",
    )
    ap.add_argument(
        "--original",
        type=Path,
        default=None,
        help="Path to pristine Geist.glyphspackage (default: ../geist-font-original/...)",
    )
